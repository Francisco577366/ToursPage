      ...
      while (1) switch (_context.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "development" === 'production' ? "https://tourspage-production.up.railway.app/api/v1/users/forgotPassword" : 'http://127.0.0.1:3000/api/v1/users/forgotPassword',
            data: email
          });
        case 2:
          res = _context.v;
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'PATCH',
            url: "development" === 'production' ? "https://tourspage-production.up.railway.app/api/v1/users/resetPassword/".concat(token) : "http://127.0.0.1:3000/api/v1/users/resetPassword/".concat(token),
            data: {
              password: password,
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "development" === 'production' ? "https://tourspage-production.up.railway.app/api/v1/users/login" : 'http://127.0.0.1:3000/api/v1/users/login',
            data: {
              email: email,
              password: password
            }
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "development" === 'production' ? "https://tourspage-production.up.railway.app/api/v1/users/logout" : 'http://127.0.0.1:3000/api/v1/users/logout'
          });
        case 1:
          res = _context2.v;
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "development" === 'production' ? "https://tourspage-production.up.railway.app/api/v1/users/signup" : 'http://127.0.0.1:3000/api/v1/users/signup',
            data: data
          });
        case 1:
          res = _context.v;
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return (0, _axios.default)("development" === 'production' ? "https://tourspage-production.up.railway.app/api/v1/bookings/checkout-session/".concat(tourID) : "http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(tourID));
        case 1:
          session = _context.v;
          _context.n = 2;
