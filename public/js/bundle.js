...
},{}],"forgot.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.passwordChange = exports.forgotPassword = void 0;
...
var forgotPassword = exports.forgotPassword = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(email) {
    var disableButton, res, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          disableButton = document.getElementById('recoverBtn');
          if (disableButton) disableButton.disabled = true;
          _context.p = 1;
          _context.n = 2;
          return (0, _axios.default)({
            method: 'POST',
            url: "development" === 'development' ? "https://tourspage-production.up.railway.app/api/v1/users/forgotPassword" : 'http://127.0.0.1:3000/api/v1/users/forgotPassword',
            data: email
          });
        case 2:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Your email has been sent. Please wait 60 seconds.');
            setTimeout(function () {
...
var passwordChange = exports.passwordChange = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(password, passwordReset) {
    var token, disableButton, res, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          token = window.location.pathname.split('/').pop();
          disableButton = document.getElementById('submitBtn');
          if (disableButton) disableButton.disabled = true;
          _context2.p = 1;
          _context2.n = 2;
          return (0, _axios.default)({
            method: 'PATCH',
            url: "development" === 'development' ? "https://tourspage-production.up.railway.app/api/v1/users/resetPassword/".concat(token) : "http://127.0.0.1:3000/api/v1/users/resetPassword/".concat(token),
            data: {
              password: password,
        ...
        case 2:
          res = _context2.v;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Your password is changed');
  ...
  return function passwordChange(_x2, _x3) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "development" === 'development' ? "https://tourspage-production.up.railway.app/api/v1/users/login" : 'http://127.0.0.1:3000/api/v1/users/login',
            data: {
              email: email,
              password: password
            }
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "development" === 'development' ? "https://tourspage-production.up.railway.app/api/v1/users/logout" : 'http://127.0.0.1:3000/api/v1/users/logout'
          });
        case 1:
          res = _context2.v;
...
var displayMap = exports.displayMap = function displayMap(locations) {
  document.addEventListener('DOMContentLoaded', function () {
    var duracion = locations.length * 1000;
    var map = L.map('map', {
    ...
    locations.forEach(function (loc, i) {
      ...
      console.log(loc);
      var marker = L.marker([lat, lng]).addTo(map).bindPopup("<p>D\xEDa ".concat(loc.day, ": ").concat(loc.description, "</p>"), {
        autoClose: false
      });
    ...
    var routeCoords = locations.map(function (loc) {
      var _loc$coordinates2 = _slicedToArray(loc.coordinates, 2),
        lng = _loc$coordinates2[0],
        lat = _loc$coordinates2[1];
...
var registerUser = exports.registerUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data) {
    var res, _err$response, message, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "development" === 'development' ? "https://tourspage-production.up.railway.app/api/v1/users/signup" : 'http://127.0.0.1:3000/api/v1/users/signup',
            data: data
          });
        case 1:
          res = _context.v;
          if (res.data.status === 'success') {
            (0, _alert.showAlert)('success', 'Your register is success Check Your email.');
          }
          _context.n = 3;
          break;
        case 2:
          _context.p = 2;
          _t = _context.v;
          message = ((_err$response = _t.response) === null || _err$response === void 0 || (_err$response = _err$response.data) === null || _err$response === void 0 ? void 0 : _err$response.message) || '';
          if (message.includes('duplicate key') && message.includes('name')) {
            (0, _alert.showAlert)('error', 'This name is already in use. Please chooose another one');
          } else if (message.includes('duplicate key') && message.includes('email')) {
            (0, _alert.showAlert)('error', 'This email is already registered. Try logging in or use another address ');
          } else {
            (0, _alert.showAlert)('error', 'Registration failed. Please try again');
          }
        case 3:
          return _context.a(2);
      }
...
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* eslint-disable */
var stripe = Stripe('pk_test_51RkEvHFQ8Q5gh1sLxqaPHPwrAGM4KmZYtPbd32JFJ8IX7Hw65ctNaFB0AZB9D92RtBbSXykB4yFELa0MQ8fyLewH00SrJjRSJs');
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          _context.n = 1;
          return (0, _axios.default)("development" === 'development' ? "https://tourspage-production.up.railway.app/api/v1/bookings/checkout-session/".concat(tourID) : "http://127.0.0.1:3000/api/v1/bookings/checkout-session/".concat(tourID));
        case 1:
          session = _context.v;
          _context.n = 2;
...
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { if (r) i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n;else { function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); } o("next", 0), o("throw", 1), o("return", 2); } }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; } /* exlint-disable */
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          _context.p = 0;
          console.log(data);
          url = type === 'password' ? 'https://tourspage-production.up.railway.app/api/v1/users/updatePassword' : 'https://tourspage-production.up.railway.app/api/v1/users/updateMe';
          _context.n = 1;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
...
var change = _interopRequireWildcard(require("./forgot.js"));
...
var sendRecoverEmail = document.getElementById('sendRecoverEmail');
    ...
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.n) {
        case 0:
          ...
          confirmPassword = document.getElementById('ConfirmPasswordRegister').value;
          _context2.n = 1;
          return (0, _register.registerUser)({
            name: name,
            email: email,
            password: password,
            confirmPassword: confirmPassword
...
if (sendRecoverEmail) sendRecoverEmail.addEventListener('submit', /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        case 0:
          ...
          passwordReset = document.getElementById('confirmPasswordReset').value;
